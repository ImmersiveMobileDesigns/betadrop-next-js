...
CREATE DATABASE betadrop CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE betadrop;
...
CREATE TABLE share_links (
    ...
    token VARCHAR(255) NOT NULL UNIQUE,
    short_id VARCHAR(20) DEFAULT NULL UNIQUE,
...
CREATE TABLE guest_uploads (
    ...
    device_id VARCHAR(36) DEFAULT NULL,  -- Browser device fingerprint for ownership tracking
    download_count INT DEFAULT 0,
...
CREATE TABLE guest_upload_claims (
    id VARCHAR(36) PRIMARY KEY,
...
-- ============================================================================
-- 14. PLATFORM STATS TABLE
-- ============================================================================
-- Cumulative platform statistics (never decreases when builds are deleted)
...
INSERT INTO platform_stats (id, total_uploads, total_downloads, total_developers) VALUES (1, 0, 0, 0);
...
-- 14. platform_stats       - Cumulative platform statistics
-- ============================================================================
