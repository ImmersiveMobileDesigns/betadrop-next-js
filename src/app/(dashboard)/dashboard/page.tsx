...
import { BarChart3, Upload, Package, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:bg-white/10 transition-colors">
            ...
            <div className="relative">
              <div className="text-gray-400 text-sm font-medium uppercase tracking-wider mb-2">Total Builds</div>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-white">{allBuildsCount}</span>
                <span className="text-sm text-gray-500 font-medium">applications</span>
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:bg-white/10 transition-colors">
            ...
            <div className="relative">
              <div className="text-gray-400 text-sm font-medium uppercase tracking-wider mb-2">Total Downloads</div>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-white">{totalDownloads}</span>
                <span className="text-sm text-gray-500 font-medium">installs</span>
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:bg-white/10 transition-colors">
            ...
            <div className="relative">
              <div className="text-gray-400 text-sm font-medium uppercase tracking-wider mb-2">Storage Used</div>
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-white">{formatFileSize(totalSize)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            {builds.length > 0 && (
              <Link href="/builds" className="group flex items-center text-sm font-medium text-gray-400 hover:text-white transition-colors">
                View All Builds
            ...
            <div className="relative rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-12 text-center pointer-events-none overflow-hidden">
               ...
               <div className="relative pointer-events-auto">
                ...
                <p className="text-gray-400 max-w-sm mx-auto mb-8 text-lg">
                  Upload your first IPA or APK file to get started sharing your apps.
                </p>
                <Link 
                  href="/upload" 
