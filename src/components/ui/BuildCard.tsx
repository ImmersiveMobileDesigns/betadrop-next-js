...
export default function BuildCard({ build, onDelete }: BuildCardProps) {
  ...
  const appUrl =
    process.env.NEXT_PUBLIC_FRONT_APP_URL || "https://betadrop.app";
      ...
      <div className="relative p-5 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5">
          <div className="flex items-start space-x-5 w-full">
            ...
            <div
              className={`relative w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg overflow-hidden ${
                build.platform === "ios"
            ...
            >
              ...
              <div
                className={`${build.icon_url ? "hidden" : ""} flex items-center justify-center`}
              >
                {platformIcon}
              </div>
            ...
            >
              ...
              {copied ? (
                ...
                <>
                  ...
                  <span className="text-gray-300 group-hover/btn:text-white font-medium text-sm transition-colors">
                    Copy Link
                  </span>
                </>
              )}
