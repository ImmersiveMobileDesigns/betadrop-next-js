      ...
      <div className="w-full max-w-xs sm:max-w-sm lg:max-w-md">
        <div className="relative group">
          ...
          <div className="relative bg-[#12121a] rounded-xl sm:rounded-2xl border-2 border-dashed border-blue-500/30 p-6 sm:p-8 lg:p-12 flex flex-col items-center justify-center">
            ...
            <p className="text-white font-bold text-base sm:text-lg lg:text-xl mb-1 sm:mb-2 text-center">
            ...
            <div className="mt-4 sm:mt-5 flex gap-2 sm:gap-3">
              <span className="px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-blue-500/20 text-blue-400 text-[10px] sm:text-xs font-semibold border border-blue-500/30">
                .ipa
              </span>
              <span className="px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] sm:text-xs font-semibold border border-emerald-500/30">
                .apk
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="relative group cursor-pointer">
            ...
            <div className="relative bg-[#12121a] rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-blue-500/20">
              ...
              <h4 className="text-white font-bold text-sm sm:text-base mb-0.5 sm:mb-1">
                iOS
              </h4>
              <p className="text-white/40 text-[10px] sm:text-xs">
                Tap to install
    ...
    <div className="w-full h-full flex flex-col p-4 sm:p-5 lg:p-6 bg-gradient-to-b from-[#0a0a12] to-[#0d0d18]">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mb-3 sm:mb-4">
        {[
          ...
          <div
            key={i}
            className="bg-[#12121a] rounded-lg sm:rounded-xl p-2 sm:p-3 border border-white/5"
          >
            <p className="text-white/40 text-[8px] sm:text-[10px] mb-0.5">
              {stat.label}
            </p>
      ...
      <div className="flex-1 bg-[#12121a] rounded-lg sm:rounded-xl p-2 sm:p-3 border border-white/5">
        <p className="text-white/50 text-[10px] sm:text-xs font-medium mb-2 sm:mb-3">
          Downloads
        </p>
          ...
          {[40, 65, 45, 80, 55, 90, 75].map((h, i) => (
            ...
            >
              <div
                ...
                style={{ height: `${h}%` }}
              />
              <span className="text-white/20 text-[6px] sm:text-[8px]">
                {["M", "T", "W", "T", "F", "S", "S"][i]}
              </span>
            </div>
          ))}
...
function MacBookFrame({
  ...
  return (
    ...
    >
      ...
      <div
        className="macbook-body relative"
      ...
      >
        ...
        <div className="relative bg-gradient-to-b from-[#2a2a35] to-[#1a1a22] rounded-t-[10px] sm:rounded-t-[14px] lg:rounded-t-[18px] p-[4px] sm:p-[6px] lg:p-[8px] shadow-2xl shadow-black/50">
          ...
          <div className="relative bg-[#0a0a0f] rounded-[6px] sm:rounded-[8px] lg:rounded-[10px] overflow-hidden shadow-inner">
            ...
            <div
              className="screen-content aspect-[16/10] w-full overflow-hidden"
              style={{ transformStyle: "preserve-3d" }}
            >
              {children}
            </div>
