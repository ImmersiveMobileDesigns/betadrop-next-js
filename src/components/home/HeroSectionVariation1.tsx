...
export default function HeroSectionVariation1() {
  return (
    <section
      className="relative min-h-[calc(100dvh-5rem)] flex items-center mt-20 pb-10 px-4 z-10 overflow-visible"
      style={{ contain: "layout" }}
    >
      <div className="max-w-6xl w-full mx-auto text-center relative px-4 !text-left">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <AnimateOnScroll
              ...
              threshold={0.2}
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tighter leading-[1.1]">
                Ship Apps{" "}
            ...
            >
              <p className="text-base sm:text-lg md:text-xl text-blue-200/60 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                ...
                share Android & iOS builds. No waiting for reviews, no
