...
export const ANIMATION_CONFIG = {
  ...
  gpu: {
    ...
    willChangeActive: "transform, opacity, filter" as const,
 ...
 */
export const shouldDisableEffect = (
  effect: "blur" | "shadow" | "parallax",
): boolean => {
...
export function createTransition(
  ...
  return `opacity ${optimizedDuration}ms ${easing} ${delay}ms, transform ${optimizedDuration}ms ${easing} ${delay}ms, filter ${optimizedDuration}ms ${easing} ${delay}ms`;
}
